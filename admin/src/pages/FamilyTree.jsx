...
function FamilTree() {
    ...
    useEffect( () => {
        async function fetchMyAPI() {
            let rabbits = await axios.get(BASE_URL + "/family-rabbits").then(res => res.data);

            let breedingPairs = await axios.get(BASE_URL + "/family-breeding").then(res => res.data);
            ...
            for await (var key of mapRabbit.keys()){
                if(mapRabbit.get(key).breeding_pair_id !== null){
                    const gkey = mapRabbit.get(mapBP.get(mapRabbit.get(key).breeding_pair_id).buck_id).id;
    ...
    return (
        <div className="grid-container">
            ...
            <div className="main-container bg-light">
                ...
                <div id="treeWrapper" style={{ width: '50em', height: '20em' }} className="d-flex justify-content-between h-100 w-100">
                    <Tree data={orgChart} />
                </div>
